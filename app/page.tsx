...
const chats = [
  ...
  {
    href: "/mowing-20260826/",
    kind: "벌초·작업기록",
    title: "2026-08-26 화곡농장 벌초 작업 기록",
    description: "오전 7시부터 오후 2시까지 삯일꾼이 벌초한 기록으로, 작업비 35만 원과 현장 사진 6장·영상을 함께 정리했습니다.",
    meta: ["07:00~14:00", "작업비 350,000원", "사진 6장·영상 1개"],
  },
  {
  ...
  {
    href: "/onion-sourcing-20260810",
    kind: "구매·거래처",
    title: "2026-08-10 양파 구매처 조사",
    description: "식당용 국산 양파 15kg 30망을 확보하기 위해 서산 지역 농가·농협·유통업체에 문의한 결과입니다.",
    meta: ["15kg × 30망", "총 450kg", "가격·회신 현황"],
  },
  {
